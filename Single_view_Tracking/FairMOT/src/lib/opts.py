...
class opts(object):
  def __init__(self):
    ...
    self.parser.add_argument('--test_divo_train', default=False, help='test divo train') 
    ...
    self.parser.add_argument('--test_sompt22_train_paper', default=False, help='test sompt22_train_paper')
    self.parser.add_argument('--test_sompt22_train_10secs_clear', default=False, help='test sompt22_train_10secs_clear')
    self.parser.add_argument('--test_sompt22_train_10secs_occlusion', default=False, help='test sompt22_train_10secs_occlusion')
  ...
  def init(self, args=''):
    default_dataset_info = {
      'mot': {'default_resolution': [544, 960], 'num_classes': 1,
